...
Order.create(customer_id: '1', postal_code: '1110000', address: '七石山病院', name: 'キキとメイのお母さん', shipping_cost: '800', total_payment: '2285', payment_method: 0, status: 0)
OrderDetail.create(order_id: '1', item_id: '1', price: '1350', amount: '3', making_status: 0)
Order.create(customer_id: '2', postal_code: '1110000', address: 'ハウルの動く城', name: 'ハウルとソフィー', shipping_cost: '800', total_payment: '2120', payment_method: 0, status: 0)
OrderDetail.create(order_id: '2', item_id: '2', price: '1200', amount: '3', making_status: 0)
Order.create(customer_id: '3', postal_code: '1110000', address: 'カリオストロの城', name: 'ルパン三世', shipping_cost: '800', total_payment: '2120', payment_method: 0, status: 0)
OrderDetail.create(order_id: '3', item_id: '2', price: '1200', amount: '3', making_status: 0)
Order.create(customer_id: '1', postal_code: '1110000', address: '七石山病院', name: 'キキとメイのお母さん', shipping_cost: '800', total_payment: '2285', payment_method: 0, status: 0)
OrderDetail.create(order_id: '4', item_id: '1', price: '1350', amount: '3', making_status: 0)